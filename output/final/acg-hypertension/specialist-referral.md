...
section_id: "specialist-referral"
section_title: "Specialist Referral and Follow-up"
source_pages: [8]
parent_section: "root"
content_types: [prose, referral_criteria, monitoring_schedule]
...
Home BP monitoring should be encouraged where possible (see [Home BP Monitoring](./home-bp-monitoring.md)). Monitor patients closely and adjust the management plan accordingly if complications or treatment-related adverse events arise.

### Ongoing monitoring parameters

Continue reviewing cardiovascular risk factors and parameters where appropriate, including:

- BP
- Lipids profile
- Weight, body mass index
- Cardiac and kidney assessment (such as estimated glomerular filtration rate and urinary albumin:creatinine ratio)
- Kidney function
- Electrolytes (e.g., serum potassium)
