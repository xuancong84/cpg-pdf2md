...
section_id: "diagnosis-and-risk"
section_title: "Diagnosis, Classification, and Cardiovascular Risk Assessment"
source_pages: [2]
parent_section: "root"
content_types: [prose]
...
# Diagnosis, Classification, and Cardiovascular Risk Assessment

## BP Classification

Accurate diagnosis of hypertension is important, as management is often lifelong and can involve multiple medications. Definitions used in this clinical guidance are based on clinic BP readings:

- **High-normal BP**: clinic BP ≥130–139/85–89 mmHg
- **Grade 1 hypertension and above**: clinic BP ≥140/90 mmHg
...
Identify risk factors that increase the risk of CVD, including:
...
In the absence of conditions known to influence cardiovascular risk, additional factors that should be considered to further inform overall assessment and guide individualised management include:
...
The use of clinic BP and cardiovascular risk assessment to inform pharmacotherapy options is discussed further in [Lifestyle Intervention and Initiation of Pharmacotherapy](./lifestyle-intervention.md).
...
>
> For more information, see [Home BP Monitoring](./home-bp-monitoring.md).
