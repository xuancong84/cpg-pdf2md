...
3. Copy rectified files to output/{basename}/final/
4. Update YAML frontmatter: validated: true, validated_date: today
5. Generate summary report

## Output
- output/{basename}/final/ (rectified, validated files)
- eval/{basename}/rectification-summary.md

Summary format:
## Rectification Summary: {cpg-name}
...
- Rectification summary is complete and honest
